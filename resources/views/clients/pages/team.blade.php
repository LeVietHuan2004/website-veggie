                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="ltn__team-item">
                            <div class="team-img">
                                <img src="{{ asset('assets/clients/img/team/1.jpg') }}" alt="Hình thành viên 1">
                            </div>
                            <div class="team-info">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="ltn__team-item">
                            <div class="team-img">
                                <img src="{{ asset('assets/clients/img/team/2.jpg') }}" alt="Hình thành viên 2">
                            </div>
                            <div class="team-info">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="ltn__team-item">
                            <div class="team-img">
                                <img src="{{ asset('assets/clients/img/team/3.jpg') }}" alt="Hình thành viên 3">
                            </div>
                            <div class="team-info">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="ltn__team-item">
                            <div class="team-img">
                                <img src="{{ asset('assets/clients/img/team/4.jpg') }}" alt="Hình thành viên 4">
                            </div>
                            <div class="team-info">
                                <h6 class="ltn__secondary-color">Nông dân hữu cơ</h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="ltn__team-item">
                            <div class="team-img">
                                <img src="{{ asset('assets/clients/img/team/5.jpg') }}" alt="Hình thành viên 5">
                            </div>
                            <div class="team-info">
                                <h6 class="ltn__secondary-color">Nông dân hữu cơ</h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="ltn__team-item">
                            <div class="team-img">
                                <img src="{{ asset('assets/clients/img/team/6.jpg') }}" alt="Hình thành viên 6">
                            </div>
                            <div class="team-info">
                                <h6 class="ltn__secondary-color">Nông dân hữu cơ</h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="ltn__team-item">
                            <div class="team-img">
                                <img src="{{ asset('assets/clients/img/team/7.jpg') }}" alt="Hình thành viên 7">
                            </div>
                            <div class="team-info">
                                <h6 class="ltn__secondary-color">Nông dân hữu cơ</h6>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="ltn__team-item">
                            <div class="team-img">
                                <img src="{{ asset('assets/clients/img/team/8.jpg') }}" alt="Hình thành viên 8">
                            </div>
                            <div class="team-info">
                                <h6 class="ltn__secondary-color">Nông dân hữu cơ</h6>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="ltn__progress-bar-wrap">
                    <div class="section-title-area ltn__section-title-2">
                        ...
                        <h1 class="section-title">Đội ngũ của chúng tôi có tay nghề cao<span>.</span></h1>
                        <p>Chúng tôi sở hữu đội ngũ chuyên nghiệp với nhiều năm kinh nghiệm trong nông nghiệp hữu cơ, cảnh quan và trồng trọt bền vững.</p>
                    </div>
                    ...
                    <div class="ltn__progress-bar-inner">
                        <div class="ltn__progress-bar-item">
                            ...
                            <div class="progress">
                                <div class="progress-bar wow fadeInLeft"
                                    data-wow-duration="0.5s" data-wow-delay=".5s"
                        ...
                        <div class="ltn__progress-bar-item">
                            ...
                            <div class="progress">
                                <div class="progress-bar wow fadeInLeft"
                                    data-wow-duration="0.5s" data-wow-delay=".5s"
                                    role="progressbar" style="width: 81%">
                                    <span>81%</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6 align-self-center">
                <div class="about-img-right">
                    <img src="{{ asset('assets/clients/img/team/t-4.jpg') }}" alt="Hình đội ngũ">
                </div>
            </div>
        </div>
    </div>
