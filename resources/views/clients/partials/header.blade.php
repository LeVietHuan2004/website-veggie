            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="ltn__top-bar-menu">
                        <ul>
                            <li><a href="locations.html"><i class="icon-placeholder"></i> Le Thuy, Quang Binh</a></li>
                            <li><a href="mailto:minhdien.dev@gmail.com?Subject=Contact%20with%20to%20you"><i
                                        class="icon-mail"></i> huanlee2004@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-5">
...
<div class="ltn__utilize_overlay"></div>